 ...
 */
declare function ThemeProvider({ theme: themeProp, overrides, dir: dirProp, scope, themes, persist, className, children, }: ThemeProviderProps): React$1.JSX.Element;
