...
declare const Badge: {
    ({ className, variant, ...props }: BadgeProps): React$1.JSX.Element;
    displayName: string;
};
...
declare const Calendar: {
    ({ className, classNames, showOutsideDays, ...props }: CalendarProps): React$1.JSX.Element;
    displayName: string;
};
...
declare const CommandInputPrimitive: React$1.ForwardRefExoticComponent<Omit<Omit<Pick<Pick<React$1.DetailedHTMLProps<React$1.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>, "key" | keyof React$1.InputHTMLAttributes<HTMLInputElement>> & {
    ref?: React$1.Ref<HTMLInputElement>;
} & {
    asChild?: boolean;
}, "key" | "asChild" | keyof React$1.InputHTMLAttributes<HTMLInputElement>>, "onChange" | "value" | "type"> & {
...
declare const DirectionalArrow: {
    ({ isRTL, size, className }: DirectionalArrowProps): React$1.JSX.Element;
    displayName: string;
};
 ...
 */
declare const LinkifyText: {
    ({ children, className }: LinkifyTextProps): React__default.JSX.Element | null;
    displayName: string;
};
 ...
 *   </NativeSelect>
 */
declare const NativeSelect: React$1.ForwardRefExoticComponent<React$1.SelectHTMLAttributes<HTMLSelectElement> & React$1.RefAttributes<HTMLSelectElement>>;
...
declare function useOptionalSidebar(): SidebarContext | null;
...
declare const Skeleton: {
    ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>): React$1.JSX.Element;
    displayName: string;
};
...
declare const Toaster: {
    ({ theme, ...props }: ToasterProps): React$1.JSX.Element;
    displayName: string;
};
